...
import org.springframework.stereotype.Service;
	...
	@Service
	public class SupplementsInfoService {
	    public static void SupplementsInfo() throws IOException {
	        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1471000/HtfsInfoService2/getHtfsItem"); /*URL*/
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=서비스키"); /*Service Key*/
	        urlBuilder.append("&" + URLEncoder.encode("Prduct","UTF-8") + "=" + URLEncoder.encode("영양칼슘비타민", "UTF-8")); /*제품명*/
