				...
				<table>
					...
					<tr id="search_color">
						...
						<td>
							...
							<div class="colorRed"><input type="checkbox" id="" name="color_class" value="하양" /><span>하양</span></div>
							<div class="colorYellow"><input type="checkbox" id="" name="color_class" value="노랑" /><span>노랑</span></div>
					...
					<tr>
						...
						<td>
							...
							<label for="drugLineEtc"> <span>없음</span>
							<input type="checkbox" id="drugLine3" name="line_front" value="" />
							</label>
