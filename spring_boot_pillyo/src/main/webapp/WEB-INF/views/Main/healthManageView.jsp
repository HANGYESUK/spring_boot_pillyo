...
<jsp:include page="/WEB-INF/views/chatBot.jsp"/>
	<div id="wrap">
			...
			<h3>${famMember} 님의 건강관리 입니다.</h3><br><br>
			    ...
			    <div class="health-Btn-Container low">
			  		<button class="health-Btn active" id="body-Btn" value=0 onclick="change(this.value); active(this);">체형</button>
				    <button class="health-Btn" id="pressure-Btn" value=1 onclick="change(this.value); active(this);">혈압</button>
				    <button class="health-Btn" id="feel-Btn" value=2 onclick="change(this.value); active(this);">기분</button>
				    <button class="health-Btn" id="sugur-Btn" value=3 onclick="change(this.value); active(this);">혈당</button>
			    </div>
    ...
    */
    ...
    <script>
      ...
      function active(a) {
          let healthBtn = document.getElementsByClassName('health-Btn')

          for(let i=0; i<healthBtn.length; i++) {
            healthBtn[i].classList.remove('active');
          }
